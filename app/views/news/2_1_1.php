...
<form action="" method="post">
    <fieldset>
        ...
        <select name="lease" id="lease">
            ...
            <option value="61" <?php inputToSelect('lease','61'); ?> >Полгода</option>
    ...
    <fieldset>
        ...
        <br>
        <b>Площадь</b><br>
        <label for="resedential">Жилая:</label><br>
        <input id="resedential" name="resedential" <?php inputToInput("resedential"); ?> type="text"><br>
    ...
    <fieldset>
        ...
        <label>Наличие мусоропровода <input type="hidden" name="availability_of_garbage_chute" value=""> <input type="checkbox" name="availability_of_garbage_chute" <?php inputToCheckbox("availability_of_garbage_chute"); ?> ></label><br>
