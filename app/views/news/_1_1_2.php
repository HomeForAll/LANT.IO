Нежилая - Арендовать - Офисная площадь
...
<option value="131">Вид постройки</option>
</select><br>
...
<option value="20">Тип здания</option>
</select><br>
...
<label style="margin-left: 40px;"> Документы на право владения <input type="checkbox" name="documents_on_tenure"></label><br><br></fieldset><br><input type="submit" name="submit" value="Найти"><br></form>