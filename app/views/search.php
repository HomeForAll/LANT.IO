...
<form action="/search" method="post">
        ...
        <div style="margin: 15px">
            ...
            <div style="padding-left: 30px">
                ...
                <select name="bargain" id="bargain">
                    <option value="yes" selected>Возможен</option>
    ...
    <input style="margin-top: 20px" type="submit" name="submit" value="Найти">
</form>
<br><br>
<h2>Арендоавть:</h2><br>
        ...
        <div style="margin: 15px">
            ...
            <div class="indent">
                ...
                <select name="rentType" id="rentType">
                    <option value="hourRent" selected>Часовая</option>
            ...
            Расположение: <br>
            <div class="indent">
                <label for="rentRegion">Область:</label>
                <input type="text" name="rentRegion" id="rentRegion"><br>
                <label for="rentCity">Город:</label>
                <input type="text" name="rentCity" id="rentCity"><br>
                <div class="indent">
                    <label for="rentDistrict">Округ:</label>
                    <input type="text" name="rentDistrict" id="rentDistrict"><br>
                    <label for="rentArea">Район:</label>
                    <input type="text" name="rentArea" id="rentArea"><br>
                    <label for="rentAddress">Адрес:</label>
                    <input type="text" name="rentAddress" id="rentAddress"><br>
                </div>
                Станция метро: <br>
                <div class="indent">
                    Удаленность от метро:
                    <input type="text" name="rentMetroMin" placeholder="Мин.">
                    <input type="text" name="rentMetroMax" placeholder="Макс."><br>
                </div>
            </div>
        </div>
    </fieldset>
    ...
    <fieldset>
        ...
        <div style="margin: 15px">
            ...
            <div class="indent">
                ...
                Площадь:
                <input type="text" name="rentSpaceMin" placeholder="От">
                <input type="text" name="rentSpaceMax" placeholder="До"><br>

                Этаж:
                <input type="text" name="rentFloorMin" placeholder="От">
                <input type="text" name="rentFloorMax" placeholder="До"><br>

                <label for="rentEquipment">Комплектация:</label>
                <select name="rentEquipment" id="rentEquipment">
                    <option value="1">Укомплектована</option>
                    <option value="">Пустая</option>
                </select><br>

                <label for="rentCeilingHeight">Высота потолков:</label>
                <input type="text" name="rentCeilingHeight" id="rentCeilingHeight">
            </div>
        </div>
        <div style="margin: 15px">
            <strong>Дом квартиры:</strong>
            <div class="indent">
                <label for="rentHouseType">Тип дома:</label>
                <select name="rentHouseType" id="rentHouseType" onchange="">
                ...
                <label for="rentHouseFloorNumber">Количество этажей:</label>
                <input type="text" name="rentHouseFloorNumber" id="rentHouseFloorNumber"><br>

                <label for="rentLift">Лифт:</label>
                <select name="rentLift" id="rentLift" onchange="">
                    <option value="1">Есть</option>
                    <option value="2">Нет</option>
                </select><br>

                <label for="rentParking">Парковка:</label>
                <select name="rentParking" id="rentParking" onchange="">
                ...
                <label for="rentChute">Мусоропровод:</label>
                <select name="rentChute" id="rentChute" onchange="">
            ...
            <div class="indent">
                <label for="rentLift">План квартиры:</label>
                <select name="rentLift" id="rentLift" onchange="">
                    <option value="1">Есть</option>
                    <option value="2">Нет</option>
                </select><br>
                <label for="rentLift">3D проект:</label>
                <select name="rentLift" id="rentLift" onchange="">
                    <option value="1">Есть</option>
                    <option value="2">Нет</option>
                </select><br>
                <label for="rentLift">Видео:</label>
                <select name="rentLift" id="rentLift" onchange="">
                    <option value="1">Есть</option>
                    <option value="2">Нет</option>
                </select><br>
