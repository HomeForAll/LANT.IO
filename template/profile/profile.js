$(function () {
    ...
    var renderItems = function(data) {
        ...
        $("<div>").addClass('profile-item__metro').html(`<svg width="19" height="13"><use xlink:href="#i-metro" x="0" y="0"></use></svg> ${data.metro_station}`).appendTo(detail);
    ...
    var renderFavorite = function(data) {
        ...
        $("<div>").addClass('profile-item__metro').html(`<svg width="19" height="13"><use xlink:href="#i-metro" x="0" y="0"></use></svg> ${data.metro_station}`).appendTo(ad);
