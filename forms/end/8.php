Нежилая - Купить - Офисная площадь с землей
...
<select name="bathroom_location" id="sanitation" style="margin-left: 60px;">
                                        ...
                                        <label style="margin-left: 60px;">Описание <input type="checkbox" name="bathroom_description"></label><br><br></fieldset><br><fieldset>
<legend>Объект размещен</legend><br>
<br></fieldset><br><fieldset>
<legend>Документы</legend><br>
<label style="margin-left: 20px; box-sizing: border-box;">Документы на право владения <input type="checkbox" name="documents_on_ownership"></label><br>
<label style="margin-left: 20px; box-sizing: border-box;">Документы на собственность <input type="checkbox" name="property_documents"></label><br>
<br></fieldset><br><fieldset>
<legend>Вложения</legend><br>
<label style="margin-left: 20px; box-sizing: border-box;">Проект планировки <input type="checkbox" name="planning_project"></label><br>
<label style="margin-left: 20px; box-sizing: border-box;">3d проект <input type="checkbox" name="three_d_project"></label><br>
