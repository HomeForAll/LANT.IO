...
<label style="margin-left: 40px; box-sizing: border-box;" for="resedential-min">Жилая:</label><br>
<input style="margin-left: 40px; box-sizing: border-box;" id="resedential-min" name="resedential-min" type="text" placeholder="от"><br>
<input style="margin-left: 40px; box-sizing: border-box;" id="resedential-max" name="resedential-max" type="text" placeholder="до"><br>
<label style="margin-left: 40px; box-sizing: border-box;" for="not_resedential-min">Нежилая:</label><br>
<input style="margin-left: 40px; box-sizing: border-box;" id="not_resedential-min" name="not_resedential-min" type="text" placeholder="от"><br>
<input style="margin-left: 40px; box-sizing: border-box;" id="not_resedential-max" name="not_resedential-max" type="text" placeholder="до"><br>
<label style="margin-left: 40px; box-sizing: border-box;" for="common-min">Общая:</label><br>
<input style="margin-left: 40px; box-sizing: border-box;" id="common-min" name="common-min" type="text" placeholder="от"><br>
<input style="margin-left: 40px; box-sizing: border-box;" id="common-max" name="common-max" type="text" placeholder="до"><br>
