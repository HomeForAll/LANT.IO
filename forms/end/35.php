Нежилая - Арендовать - Комплекс ОСЗ
...
<label style="margin-left: 40px;">Документы на право владения <input type="checkbox" name="ownership_documents"></label><br><br></fieldset><br><fieldset>
