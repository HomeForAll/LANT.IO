Нежилая - Арендовать - Производственно-складские помещения 
...
<label style="margin-left: 40px;">Документы на право владения <input type="checkbox" name="documents_on_tenure"></label><br><br></fieldset><br><fieldset>
...
<select name="bathroom_location" id="sanitation" style="margin-left: 60px;">
                                        ...
                                        <label style="margin-left: 60px;">Описание <input type="checkbox" name="bathroom_description"></label><br><label style="margin-left: 20px; box-sizing: border-box;" for="year_of_construction-min">Год постройки/окончания строительства:</label><br>
