Нежилая - Арендовать - Торговое здание
<br><form action="" method="post">
<fieldset>
<legend>Вложения</legend><br>
<label style="margin-left: 20px; box-sizing: border-box;" for="sanitation">Водопровод и канализация</label><br>
<select style="margin-left: 20px; box-sizing: border-box;" name="sanitation" id="sanitation">
<option value="101">Возможность проводки</option>
